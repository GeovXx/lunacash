...
class ReceivableForm extends Component
{
    ...
    protected $listeners = ['openReceivableForm'];

    public function openReceivableForm($data = null)
    {
    ...
    public function save(FinancialObligationService $service)
    {
        ...
        try {
            if ($this->obligationId) {
                ...
                $service->updateReceivable($obligation, $data);
                $this->dispatch('receivableUpdated');
            } else {
                $service->createReceivable($data);
                $this->dispatch('receivableCreated');
            }
    ...
    public function render()
    {
        ...
        return view('livewire.receivables.receivable-form', [
            'accounts' => $accounts,
